...
// Initial state with defaults for all relevant data
const initialState = {
    status: 'idle',
    loading: false,
...
// Helper function to update cart details in localStorage
...
// Helper function to update shipping data in localStorage
